...
+----------------------------------------------------------------------
| 安装脚本：curl -sSO https://raw.githubusercontent.com/loadream/BTPanel/main/install/install_panel.sh && bash install_panel.sh
+----------------------------------------------------------------------
"
while [ "$go" != 'y' ] && [ "$go" != 'n' ]
do
...
if [ -f ${plugin_file} ];then
    ...
    wget https://raw.githubusercontent.com/loadream/BTPanel/main/bthappy/plugin.json
    chattr +i /www/server/panel/data/plugin.json
else
    cd /www/server/panel/data
    wget https://raw.githubusercontent.com/loadream/BTPanel/main/bthappy/plugin.json
...
if [ -f ${repair_file} ];then
    ...
    cd /www/server/panel/data
    wget https://raw.githubusercontent.com/loadream/BTPanel/main/bthappy/repair.json
    chattr +i /www/server/panel/data/repair.json
else
    cd /www/server/panel/data
    wget https://raw.githubusercontent.com/loadream/BTPanel/main/bthappy/repair.json
